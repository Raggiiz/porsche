...
Command: npx gltfjsx@6.1.11 public/externalEnvironment/scene.gltf -t -r public
Author: 99.Miles (https://sketchfab.com/99.Miles)
License: SKETCHFAB Standard (https://sketchfab.com/licenses)
Source: https://sketchfab.com/3d-models/autumn-mountain-road-scene-24947115dc3348f7915e1e155080ad5c
Title: Autumn mountain road scene
*/
...
export default function External(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/externalEnvironment/scene.gltf') as GLTFResult
  return (
...
useGLTF.preload('/externalEnvironment/scene.gltf')
