...
export default function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const primaryColor = new THREE.MeshPhysicalMaterial({ color: 'gray', roughness: 0.2, metalness: 0.8 });
  const secondaryColor = new THREE.MeshPhysicalMaterial({ color: 'gray', roughness: 0.2, metalness: 0.8 });
  const wheels = new THREE.MeshPhysicalMaterial({ color: 'white', roughness: 0.2, metalness: 0.8 });
  const breaks = new THREE.MeshPhysicalMaterial({ color: 'green', roughness: 0.2, metalness: 0.8 });
  ...
  const internalColor = new THREE.MeshStandardMaterial({ normalMap: normalMap, color: '#3d280a'});
  
  return (
    <group {...props} dispose={null}>
      
      <group position={[0, 0, -0.92]} rotation={[1.57, 0, 0]} scale={0.33}>
        {/* <mesh geometry={nodes.Object_10.geometry} material={materials.Paint} />
        <mesh geometry={nodes.Object_11.geometry} material={materials.Paint} /> */}
        <mesh geometry={nodes.Object_10.geometry} material={primaryColor} />
        <mesh geometry={nodes.Object_11.geometry} material={primaryColor} />
        ...
        {/* <mesh geometry={nodes.Object_14.geometry} material={materials.Carbon1} /> */}
        <mesh geometry={nodes.Object_14.geometry} material={secondaryColor} />
        ...
        <mesh geometry={nodes.Object_32.geometry} material={internalColor} />
      ...
      <group position={[2.93, 1.13, 3.05]} rotation={[1.57, -0.02, 0]} scale={0.33}>
        <mesh geometry={nodes.Object_41.geometry} material={materials.Wheel1A} />
        {/* <mesh geometry={nodes.Object_42.geometry} material={wheels} /> */}

        {/* <Wheel /> */}
        <Wheel2 />

        {/* <mesh geometry={nodes.Object_42.geometry} material={materials['Rims.FL']} /> */}
      ...
      <group position={[-2.93, 1.13, 3.05]} rotation={[1.57, 0.02, 0]} scale={[-0.33, 0.33, 0.33]}>
        <mesh geometry={nodes.Object_45.geometry} material={materials['Wheel1A.001']} />
        <mesh geometry={nodes.Object_46.geometry} material={wheels} />
        {/* <mesh geometry={nodes.Object_46.geometry} material={materials['Rims.FL.001']} /> */}
      ...
      <group position={[-2.95, 1.18, -4.91]} rotation={[1.57, 0.02, 0]} scale={[-0.39, 0.34, 0.34]}>
        <mesh geometry={nodes.Object_52.geometry} material={materials['Wheel1A.002']} />
        <mesh geometry={nodes.Object_53.geometry} material={wheels} />
        {/* <mesh geometry={nodes.Object_53.geometry} material={materials['Rims.FL.002']} /> */}
      ...
      <group position={[2.97, 1.18, -4.91]} rotation={[1.57, -0.02, 0]} scale={[0.39, 0.34, 0.34]}>
        ...
        <mesh geometry={nodes.Object_57.geometry} material={wheels} />
        {/* <mesh geometry={nodes.Object_57.geometry} material={materials['Rims.FL.003']} /> */}
      ...
      <group position={[0, 0, -0.92]} rotation={[1.57, 0, 0]} scale={[-0.33, 0.33, 0.33]}>
        <mesh geometry={nodes.Object_49.geometry} material={breaks} />
        {/* <mesh geometry={nodes.Object_49.geometry} material={materials['ColouredMtl.001']} /> */}
        <mesh geometry={nodes.Object_50.geometry} material={breaks} />
        {/* <mesh geometry={nodes.Object_50.geometry} material={materials['paint1Mtl.001']} /> */}
      </group>
      <group position={[0.05, 0, -0.86]} rotation={[1.57, 0, 0]} scale={[-0.32, 0.32, 0.32]}>
        {/* <mesh geometry={nodes.Object_60.geometry} material={materials['ColouredMtl.003']} />
        <mesh geometry={nodes.Object_61.geometry} material={materials['paint1Mtl.003']} /> */}
        <mesh geometry={nodes.Object_60.geometry} material={breaks} />
        <mesh geometry={nodes.Object_61.geometry} material={breaks} />
      </group>
      <group position={[0, 0, -0.92]} rotation={[1.57, 0, 0]} scale={0.33}>
        {/* <mesh geometry={nodes.Object_4.geometry} material={materials.ColouredMtl} />
        <mesh geometry={nodes.Object_5.geometry} material={materials.paint1Mtl} /> */}
        <mesh geometry={nodes.Object_4.geometry} material={breaks} />
        <mesh geometry={nodes.Object_5.geometry} material={breaks} />
      </group>
      <group position={[-0.03, 0, -0.86]} rotation={[1.57, 0, 0]} scale={0.32}>
        {/* <mesh geometry={nodes.Object_7.geometry} material={materials.ColouredMtl} />
        <mesh geometry={nodes.Object_8.geometry} material={materials.paint1Mtl} /> */}
        <mesh geometry={nodes.Object_7.geometry} material={breaks} />
        <mesh geometry={nodes.Object_8.geometry} material={breaks} />
      </group>
    </group>
  )
}
